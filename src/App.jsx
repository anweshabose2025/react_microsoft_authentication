  ...
  if (account) {
    return (
      <div>
        ...
        <h5>Azure App Registration - Microsoft Authentication - Azure Storage accounts (Blob Storage) - Azure Function (Azure Function App) - Hosting in Azure (Azure Static Web App)</h5>
        <h5>MSFT Tenant            - MSFT Tenant              - Netwoven Tenant                       - Netwoven Tenant                     - Netwoven Tenant</h5>
